package jp.techacademy.hirotoshi.yoshioka.taskapp;
...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mTitleEdit, mContentEdit, mCategoryEdit; //課題：Category
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText) findViewById(R.id.category_edit_text);//課題：Category
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString();//課題：Category

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category); //課題：Category
